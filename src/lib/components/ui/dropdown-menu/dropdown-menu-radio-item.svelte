<script lang="ts">
	...
	import { Check } from "lucide-svelte"; // Zmiana z Circle na Check
...
<DropdownMenuPrimitive.RadioItem
	bind:ref
	{value}
	{closeOnSelect} class={cn(
		"group relative flex cursor-default select-none items-center gap-3 rounded-md px-2.5 py-1.5 font-sans text-sm font-medium outline-none transition-all duration-75 active:scale-[0.98]",
